...
var BaseDropdown = exports.BaseDropdown = function BaseDropdown(_ref) {
  ...
  var renderSelectionInfo = function renderSelectionInfo() {
    ...
    if (isEmpty) {
      ...
      var placeholderText = placeholder === undefined || placeholder === null ? Translator.trans(/*@Desc("Select an item")*/'ids.dropdown.placeholder') : placeholder.trim() || Translator.trans(/*@Desc("All")*/'ids.dropdown.placeholder.all');
