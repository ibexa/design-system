...
import { OverflowListDefaultItem } from './OverflowListDefaultItem';
...
export const OverflowList = <ItemProps extends { id: string }>({
    ...
    const renderItems = () => {
        const ItemComponent = itemComponent ?? OverflowListDefaultItem;

        return items.slice(0, numberOfVisibleItems).map((item: ItemProps) => {
