...
// ═══ CHROME (shared with "Content view — background publishing") ════════════════
// Top bar, icon rail, secondary nav and content-tree panel. Static — no
// background-publishing indicators in this view.

// ─── Brand mark (Cohesivo logo glyph) ──────────────────────────────────────────
...
const TREE_ROWS: TreeRowData[] = [
    { id: 'root',       name: 'Ibexa DXP',       icon: 'content-tree-site-structure', depth: 0, folder: true, expanded: true },
    { id: 'landing',    name: 'Landing pages',   icon: 'folder',     depth: 1, folder: true, expanded: true },
    { id: 'enterprise', name: 'Enterprise hero', icon: 'notes-list', depth: 2, selected: true },
    { id: 'smb',        name: 'SMB hero',        icon: 'notes-list', depth: 2 },
    { id: 'blog',       name: 'Blog',            icon: 'folder',     depth: 1, folder: true, expanded: false },
    { id: 'products',   name: 'Products',        icon: 'folder',     depth: 1, folder: true, expanded: false },
];
...
// ═══ INNER FLOW (unchanged from "Landing Block – Personalization") ══════════════
...
const PersonalizationBlockMockup = () => {
...
const meta: Meta<typeof PersonalizationBlockMockup> = {
    component: PersonalizationBlockMockup,
    title: 'Mockups/Personalization Block',
    parameters: {
        layout: 'fullscreen',
...
type Story = StoryObj<typeof PersonalizationBlockMockup>;
