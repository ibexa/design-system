...
const TypographyHeaders = () => {
    ...
    const headers = [
        { content: <h1 className="dev-h1">{sentence}</h1>, lineHeight: 36, name: 'h1', size: 24 },
        { content: <h2 className="dev-h2">{sentence}</h2>, lineHeight: 27, name: 'h2', size: 18 },
        { content: <h3 className="dev-h3">{sentence}</h3>, lineHeight: 24, name: 'h3', size: 16 },
        { content: <h4 className="dev-h4">{sentence}</h4>, lineHeight: 22.5, name: 'h4', size: 15 },
        { content: <h5 className="dev-h5">{sentence}</h5>, lineHeight: 21, name: 'h5', size: 14 },
        { content: <h6 className="dev-h6">{sentence}</h6>, lineHeight: 18, name: 'h6', size: 12 },
    ];
